...
<template>
  <info-frame>
    <div slot="title">
      <div class="subTitle">抄表记录</div>
    </div>
    <div slot="default" class="frameBody">
      <el-card shadow="never" class="listItem">
