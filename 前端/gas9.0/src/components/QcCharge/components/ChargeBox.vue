    ...
    <el-card shadow="never" class="no-border">
      ...
      <el-form v-loading="loading" label-position="top" :model="invoiceForm" class="jh-text">
        ...
        <el-form-item label="纳税人识别号">
          <el-input v-model="invoiceForm.buyerTinNo" @focus="inputFocus($event)"></el-input>
        </el-form-item>
        <el-form-item label="开户行">
          <el-input v-model="invoiceForm.buyerBankName" @focus="inputFocus($event)"></el-input>
        </el-form-item>
        <el-form-item label="账号">
          <el-input v-model="invoiceForm.buyerBankAccount" @focus="inputFocus($event)"></el-input>
        </el-form-item>
        <el-form-item label="地址">
          <el-input v-model="invoiceForm.buyerAddress" @focus="inputFocus($event)"></el-input>
        </el-form-item>
