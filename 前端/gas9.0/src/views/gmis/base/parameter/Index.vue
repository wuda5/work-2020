  ...
  <div class="app-container">
    ...
    <search-box>
      <div slot="left">
        ...
        <el-button v-has-permission="['parameter:add']" type="danger" @click="add">
          {{ $t("table.add") }}
        </el-button>
      </div>
      <div slot="right">
        <el-button v-has-permission="['parameter:delete']" type="danger" @click="batchDelete">
          {{ $t("table.delete") }}
        </el-button>

        <!--<el-dropdown v-has-any-permission="['parameter:delete', 'parameter:export', 'parameter:import']"
                     class="filter-item"
                     trigger="click"
        >
          <el-button>
    ...
    <el-table
      ...
      fit
      row-key="id"
      v-loading="loading" style="width: 100%;" @filter-change="filterChange"
    ...
    >
      ...
      <!--参数键-->
      <el-table-column :label="$t('table.parameter.key')" :show-overflow-tooltip="true"
                       prop="key" width=""
      >
      ...
      >
        <template slot-scope="{ row }">
          <el-button
            v-hasPermission="['parameter:update']"
            type="primary"
            @click="edit(row)"
          >
            {{ $t("edit") }}
          ...
          <el-button
            v-hasPermission="['parameter:delete']"
            type="danger"
