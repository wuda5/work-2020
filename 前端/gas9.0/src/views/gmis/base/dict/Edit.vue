<!--字典项 新增 | 编辑-->
<template>
  <el-dialog :close-on-click-modal="false" :close-on-press-escape="true" :title="title" :type="type" :visible.sync="isVisible" width="500px" top="50px">
    <!--表单-->
    ...
    <div class="dialog-footer" slot="footer">
      <el-button @click="isVisible = false"  type="warning">{{ $t('common.cancel') }}</el-button>
