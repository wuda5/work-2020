            ...
            <search-box>
              <div slot="left">
                ...
                <el-input
                  ...
                  style="width: 100px"
                />
                <el-button type="primary" @click="resourceSearch">{{ $t('table.search') }}</el-button>
              </div>
              <div slot="right">
                <!-- <el-button
...
export default {
  ...
  data() {
    return {
      ...
      rules: {
        ...
        path: [
          { max: 255, message: this.$t('rules.noMoreThan100'), trigger: 'blur' },
          { required: true, message: this.$t('rules.require'), trigger: 'blur' },
          {
  ...
  methods: {
    ...
    resourceFetch(params = {}) {
      ...
      this.resourceQueryParams.current = params.current
        ? params.current
        : this.resourceQueryParams.current
