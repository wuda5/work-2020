 ...
 * @LastEditors: lingw
 * @LastEditTime: 2020-11-26 09:46:32
-->
<template>
<div>
  <div v-if="orderFilesInfo.length">
    <el-card>
      ...
      <el-row :gutter="12">
        <el-col :span="12">
          <p>工单类型: {{ orderInfo.workOrderType | filterName }}</p>
        </el-col>
        <el-col :span="12">
          <p>紧急程度: 
      ...
      <div>
        <el-image v-for="info in orderFilesInfo" :key="info.id"
          style="width: 100px; height: 100px; margin-left: 8px;"
