 ...
 * @LastEditors: lingw
 * @LastEditTime: 2020-11-26 09:36:35
-->
<template>
 <div>
   <el-form ref="overForm" :model="overForm" :rules="rules" class="jh-text" label-position="top">
    ...
    <el-form-item label="工单类型" prop="workOrderType">
      <el-select v-model="overForm.workOrderType" disabled>
        <el-option v-for="orderType in orderTypeList" :key="orderType.code" :value="orderType.code" :label="orderType.name"></el-option>
      </el-select>
    </el-form-item>
