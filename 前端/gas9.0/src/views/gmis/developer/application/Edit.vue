  ...
  export default {
    ...
    data() {
      return {
        ...
        serviceList: [
          {id: "gmis-authority-server", name: "权限服务"},
          {id: "gmis-file-server", name: "文件服务"},
          {id: "gmis-msgs-server", name: "消息服务"},
          {id: "gmis-demo-server", name: "演示服务"},
          {id: "gmis-order-server", name: "订单服务"},
        ]
      }
    },
    computed: {
