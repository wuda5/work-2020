            ...
            <el-col :sm="12" :xs="24">
              <div class="user-wrapper">
                ...
                <div class="user-info">
                  ...
                  <div class="user-dept">
                    <span>{{
                      user.workDescribe ? user.workDescribe : $t('common.noWorkDescribe')
                    }}</span>
                  </div>
                  <div class="user-login-info">
                    {{ $t('common.lastLoginTime') }}：
                    <span id="last-login-time">{{
                      user.lastLoginTime ? user.lastLoginTime : $t('common.firstLogin')
                    }}</span>
                  </div>
                </div>
              </div>
              ...
              <div class="basic-container">
                <el-card>
                  <div class="el-font-size">
                    ...
                    <span><el-tag>gmis-admin-cloud SaaS 基础开发框架</el-tag></span>
                    <el-divider direction="vertical" />
                    ...
                    <el-tag
                      ...
                      @click="handleClipboard('gmis', $event)"
                    >
                      管理员(gmis)
                    </el-tag>
                    <el-divider direction="vertical" />
                    ...
                    <el-divider content-position="right">密码都是： 123456</el-divider>
                  </div>
                </el-card>
              </div>
            </el-tab-pane>
