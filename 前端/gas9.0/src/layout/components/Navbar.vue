    ...
    <div class="right-menu">
        ...
        >
          <div class="avue-notice">
              ...
              <div class="avue-notice__content">
                ...
                >
                  <div class="avue-notice__title">
                    ...
                    <span class="avue-notice__tag"><el-tag
                      size="small"
                      effect="plain"
                      :type="item.msgsCenterType ? item.msgsCenterType['code'] : '' | msgsTypeFilter"
                    >{{ item.msgsCenterType ? item.msgsCenterType['desc'] : '' }}</el-tag></span>
                  </div>
            ...
            <div class="avue-notice__more">
              <router-link :to="{path:'/msgs/myMsgs'}">
                点击查看更多<i class="el-icon-more" />
              </router-link>
            </div>
          </div>
          <el-badge
      ...
      >
        ...
        <el-dropdown-menu slot="dropdown">
          ...
          <!--切换api地址-->
          <router-link v-if="env === 'development'" to="/select-api/index">
            <el-dropdown-item divided>
              切换后台api
            </el-dropdown-item>
          </router-link>
...
export default {
  ...
  computed: {
    ...
    orgName(){
      return this.$store.state.account.user.orgName
    }
