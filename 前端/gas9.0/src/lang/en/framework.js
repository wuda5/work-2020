...
export default {
  route: {
    ...
    community: 'community',
    gasPrice: 'gasPrice',
    serviceHallQuota: 'serviceHallQuota',
    shopAssistantQuota: 'shopAssistantQuota',
    buyGasLimit: 'buyGasLimit',
    securitySubItem: 'securitySubItem',
